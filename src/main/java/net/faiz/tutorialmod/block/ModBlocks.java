package net.faiz.tutorialmod.block;
...
public class ModBlocks {
    ...
    public static final Block GREENEY_BLUEY_BLOCK = registerBlock("greeney_bluey_block", new Block(AbstractBlock.Settings.create().strength(2f)));
